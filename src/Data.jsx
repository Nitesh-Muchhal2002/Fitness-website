...
export const values = [
  {
    ...
    desc: "We prioritize health and holistic well-being above all else. Our platform is designed to help you achieve your fitness goals safely and sustainably.",
  },
  {
    id: 2,
    icon: <SiOpenaigym />,
    title: " Personalized Approach",
    desc: "Every individual is unique. We value customization and provide tools to tailor workouts, diets, and plans to suit your personal needs.",
  },
  {
    id: 3,
    icon: <SiOpenaigym />,
    title: "Community and Support",
    desc: "We believe in the power of community. Our platform fosters a supportive environment where users can connect, motivate each other, and share their progress.",
  },
  {
    id: 4,
    icon: <SiOpenaigym />,
    title: "Continuous Improvement",
    desc: "We are committed to evolving our platform to bring you the latest innovations and improve your experience.",
  },
];
